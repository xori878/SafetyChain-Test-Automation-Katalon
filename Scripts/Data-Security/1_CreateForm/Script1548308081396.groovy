...
WebUI.click(findTestObject('Form_Selection_Creation/openResType'))

Thread.sleep(2000)

WebUI.click(findTestObject('Form_Selection_Creation/selectEquipment'))

WebUI.waitForElementClickable(findTestObject('Form_Selection_Creation/formDesign_selectResource'), 25)

Thread.sleep(2000)

CustomKeywords.'AdminTool_Location.dragDropCust'(3)
...
CustomKeywords.'AdminTool_Location.dragDropCust'(4)
...
WebUI.click(findTestObject('Form_Selection_Creation/selectSupplier'))

WebUI.waitForElementClickable(findTestObject('Form_Selection_Creation/formDesign_selectResource'), 25)

Thread.sleep(2000)

CustomKeywords.'AdminTool_Location.dragDropCust'(5)
