...
WebUI.dragAndDropToObject(findTestObject('Form_Selection_Creation/formDesign_SelectNumeric'), findTestObject('Form_Selection_Creation/default_area'))
...
WebUI.setText(findTestObject('Form_Selection_Creation/formDesign_SectionName'), 'This is Section 1')
...
WebUI.setText(findTestObject('Form_Selection_Creation/formDesign_NumericName1'), 'This is Numeric Field.')
...
WebUI.dragAndDropToObject(findTestObject('Form_Selection_Creation/formDesign_SelectNumeric'), findTestObject('Form_Selection_Creation/section_area'))

Thread.sleep(2000)

WebUI.setText(findTestObject('Form_Selection_Creation/formDesign_NumericName2'), 'This is Numeric Field.')

Thread.sleep(4000)

WebUI.click(findTestObject('Form_Selection_Creation/goToSection'))

Thread.sleep(2000)

WebUI.click(findTestObject('Form_Selection_Creation/copySection'))

Thread.sleep(4000)

WebUI.setText(findTestObject('Form_Selection_Creation/renameSection'), 'This is Section 2')
