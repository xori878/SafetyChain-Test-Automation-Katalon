...
not_run: WebUI.waitForElementClickable(findTestObject('Form_Selection_Creation/select1Res'), 45)

not_run: WebUI.dragAndDropToObject(findTestObject('Form_Selection_Creation/select1Res'), findTestObject('Form_Selection_Creation/Target_Res_Object'))

not_run: WebUI.waitForElementClickable(findTestObject('Form_Selection_Creation/select2Res'), 45)

not_run: WebUI.dragAndDropToObject(findTestObject('Form_Selection_Creation/select2Res'), findTestObject('Form_Selection_Creation/Target_Res_Object'))
