...
WebUI.click(findTestObject('TestResource/customers'))
...
CustomKeywords.'AdminTool_Location.selectCustomer'()
...
WebUI.waitForElementClickable(findTestObject('TestResource/locationTab'), 45)
