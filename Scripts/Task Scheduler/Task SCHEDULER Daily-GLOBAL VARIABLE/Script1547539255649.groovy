...
WebUI.setText(findTestObject('Task Scheduler Daily/input_USER NAME_Username'), GlobalVariable.UserName)
...
WebUI.waitForElementClickable(findTestObject('Task Scheduler Daily/span_Select Form'), 30)
...
WebUI.setText(findTestObject('Task Scheduler Daily/input_TASK NAME_scs-new-form-i'), findTestData('TaskScheduler').getValue(
        1, 1))

Thread.sleep(3000)

not_run: WebUI.click(findTestObject('Task Scheduler Daily/AddResource'))

not_run: Thread.sleep(3000)

not_run: WebUI.click(findTestObject('Task Scheduler Daily/Select_Resource'))
...
WebUI.setText(findTestObject('TaskScheduler-One time/InputSearchTaskIn_inbox'), findTestData('TaskScheduler').getValue(1, 
        1))
