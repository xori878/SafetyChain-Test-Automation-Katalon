...
WebUI.setText(findTestObject('Form_Selection_Creation/login_Password'), GlobalVariable.Password111)
...
WebElement source = driver.findElement(By.xpath("//*[@id='scs-rule-builder-right-header-container']/div[13]"))

Actions Actions = new Actions(driver);
Actions.moveToElement(source,660,230);
Actions.clickAndHold();
Actions.release();
Actions.perform();

CustomKeywords.'FormName.getSize'()
