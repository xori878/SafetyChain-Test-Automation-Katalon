...
WebUI.setText(findTestObject('Task_scheduler Weekly/input_USER NAME_Username'), GlobalVariable.UserName)

WebUI.setText(findTestObject('Task_scheduler Weekly/input_PASSWORD_Password'), GlobalVariable.Password)
...
WebUI.waitForElementClickable(findTestObject('Task_scheduler Weekly/span_Select Form'), 30)
...
WebUI.setText(findTestObject('Task_scheduler Weekly/input_TASK NAME_scs-new-form-i'), findTestData('TaskScheduler').getValue(
        2, 1))

Thread.sleep(3000)

not_run: WebUI.click(findTestObject('Task_scheduler Weekly/AddResource'))

not_run: Thread.sleep(3000)

not_run: WebUI.click(findTestObject('Task_scheduler Weekly/Select_Resource'))
...
WebUI.setText(findTestObject('Task_scheduler Weekly/input_Task Total_searchInput n'), findTestData('TaskScheduler').getValue(
        2, 1))
