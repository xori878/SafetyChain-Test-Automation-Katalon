...
not_run: WebUI.waitForElementVisible(findTestObject('TestUserLocation/login_Username'), 70)
...
CustomKeywords.'AdminTool_Location.selectLocations'()

Thread.sleep(2000)

not_run: WebUI.click(findTestObject('TestUser/selectLocation'))
