...
WebUI.setText(findTestObject('TaskScheduler-One time/input_USER NAME_Username'), GlobalVariable.UserName)

WebUI.setText(findTestObject('TaskScheduler-One time/input_PASSWORD_Password'), GlobalVariable.Password)
...
WebUI.waitForElementClickable(findTestObject('TaskScheduler-One time/span_Select Form'), 30)
...
WebUI.setText(findTestObject('TaskScheduler-One time/input_TASK NAME_scs-new-form-i'), findTestData('TaskScheduler').getValue(
        5, 1))

Thread.sleep(5000)

not_run: WebUI.click(findTestObject('TaskScheduler-One time/ClickResource'))

not_run: Thread.sleep(3000)

not_run: WebUI.click(findTestObject('TaskScheduler-One time/SelectResource'))
...
WebUI.setText(findTestObject('TaskScheduler-One time/textarea_TASK DESCRIPTION_scs-'), 'This is one time task!!')
...
WebUI.setText(findTestObject('TaskScheduler-One time/InputSearchTaskIn_inbox'), findTestData('TaskScheduler').getValue(5, 
        1))
