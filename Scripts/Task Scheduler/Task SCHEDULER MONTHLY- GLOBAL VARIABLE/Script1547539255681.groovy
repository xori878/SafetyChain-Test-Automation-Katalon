...
WebUI.setText(findTestObject('Task_scheduler Monthly/input_USER NAME_Username'), GlobalVariable.UserName)

WebUI.setText(findTestObject('Task_scheduler Monthly/input_PASSWORD_Password'), GlobalVariable.Password)
...
WebUI.setText(findTestObject('Task_scheduler Monthly/input_TASK NAME_scs-new-form-i'), findTestData('TaskScheduler').getValue(
        3, 1))

not_run: Thread.sleep(3000)

not_run: WebUI.click(findTestObject('Task_scheduler Monthly/span_Select Resource'))

not_run: Thread.sleep(3000)

not_run: WebUI.click(findTestObject('Task_scheduler Monthly/div_Instace32351'))
...
WebUI.setText(findTestObject('Task_scheduler Monthly/textarea_TASK DESCRIPTION_scs-'), 'This i s  monthly task!!')
...
WebUI.setText(findTestObject('Task_scheduler Monthly/input_Task Total_searchInput n'), findTestData('TaskScheduler').getValue(
        3, 1))
